...
![image-20220315221214132](14%20%E9%AB%98%E9%A2%91.assets/image-20220315221214132.png)

如果2在前面就是降序排列, 反之一在前就是升序排列

```java
class Solution {
    public String largestNumber(int[] nums) { 
        // 1 将所有元素添加到list后自定义排序
...
![image-20220328235430125](14 高频.assets/image-20220328235430125.png)

![image-20220329003049028](14 高频.assets/image-20220329003049028.png)

![image-20220329003150695](14 高频.assets/image-20220329003150695.png)
...
![image-20220329003432230](14 高频.assets/image-20220329003432230.png)

![image-20220330111054579](14 高频.assets/image-20220330111054579.png)
        ...
        public int minimumLengthEncoding(String[] words) {
            ...
            Arrays.sort(words, new Comparator<String>() {
                ...
                public int compare(String o1, String o2) {
                    return o2.length() - o1.length();// 先对单词列表根据单词长度由长到短排序
                }
            });
            for (String word : words) {
                len += trie.insert(word); // 单词插入trie，返回该单词增加的编码长度
            }
            return len;
        }
    }
