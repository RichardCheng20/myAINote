...
# 显示评论
##  数据层
针对讨论的讨论评论，对讨论评论。在comment表中： 
entiy_type： 评论目标的类别
entity_id: 类型的目标，例如ID为228的帖子。
target_id 对某一个评论的评论，指向某一个人。
status： 0正常，1表示删除禁用。
- 1 开发查询功能必须有实体类,根据数据库里的字段
Comment
